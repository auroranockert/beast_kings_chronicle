namespace :app do
  ...
  task :database_schema do
    unless agree("Now it's time to load the schema into the development and test databases.  Any existing data will be OVERWRITTEN. Are you sure you wish to continue? [y/n]")
      raise "Cancelled"
    end
    puts
